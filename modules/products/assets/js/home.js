...
// alert(1);
    $.ajax({
        type: 'GET',
        dataType: 'html',
        url: '/index.php?module=products&view=products&raw=1&task=view_modal&sapxep='+$sx,
        data: "id=" + $id,
        async: false,
...
$(document).ready(function() {
    ...
    var get_item = $( "#item_get_height" ).val();
    var get_height =  $("#get_height").height();
    // kq2 = getSum(get_height, get_item);
    var mr =  60;
    // var element = document.getElementById('get_height');
    // alert(get_height);
    // alert(get_item);
    // alert(get_item);
    hei = parseInt(get_height) + parseInt(get_item) + parseInt(mr);
    // alert(hei);
    document.getElementById("height_right").style.height = hei+"px";
...
$('.load_more').click(function(){
    ...
    $.ajax({
        type : 'GET',
        dataType: 'html',
        url : '/index.php?module=products&view=products&raw=1&task=nextduan',
